...
public class Config {
	...
	public static final ForgeConfigSpec.BooleanValue ENABLE_SILVER_TOOL = BUILDER
			.define("enableTierSilver", false);

	public static final ForgeConfigSpec.BooleanValue ENABLE_BRONZE_TOOL = BUILDER
			.define("enableTierBronze", false);

	public static final ForgeConfigSpec.BooleanValue ENABLE_STEEL_TOOL = BUILDER
			.define("enableTierSteel", false);

	public static final ForgeConfigSpec.BooleanValue DISPLAY_NUMERIC_COUNT = BUILDER
	...
	public static final ForgeConfigSpec.IntValue THRESHOLD_VEIN_0_ORE = BUILDER
	...
	public static final ForgeConfigSpec.IntValue THRESHOLD_VEIN_1_RAWORE = BUILDER
	...
	public static final ForgeConfigSpec.IntValue THRESHOLD_VEIN_1_ORE = BUILDER
	...
	public static final ForgeConfigSpec.IntValue THRESHOLD_VEIN_2_RAWORE = BUILDER
	...
	public static final ForgeConfigSpec.IntValue THRESHOLD_VEIN_2_ORE = BUILDER
